...
public class UIAutomatorHomeFromMainTest extends UiAutomatorTestCase {
    @Rule
    public final ActivityTestRule<AccountListActivity> main = new ActivityTestRule<AccountListActivity>(AccountListActivity.class);
    ...
    private void findAndRunApp() throws UiObjectNotFoundException, RemoteException {
        ...
        UiObject app = new UiObject(
                new UiSelector().description("Accounts")
        );
